...
transformed parameters {
  ...
  pi[4,4] = inv_logit(l_0+l_1);
  pi[5,4] = inv_logit(l_0+l_1+l_1+l5_212);
  pi[6,4] = inv_logit(l_0+l_1+l_1+l6_212);
}
model {
  array[C, C] real ps;
